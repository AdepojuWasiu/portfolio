...
const Home = () => {
  return (
    <section className={`relative w-full h-screen mx-auto sm:mb-[100px] mb-[-300px] sm:mt-0 mt-10`}>
      <div
     ...
     <div className="flex justify-center items-center sm:mt-[-100px] mt-[-380px] gap-[5px] p-[20px]">
